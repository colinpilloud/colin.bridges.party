...
export function AppLayout({ children }: AppLayoutProps) {
  return (
    <>
      <div className="flex min-h-screen overflow-hidden bg-gradient-to-bl from-black to-gray-900 to-[95%] bg-left bg-blend-multiply filter md:bg-cover md:bg-fixed screen:uppercase screen:text-primary screen:md:bg-[url('me-grainy.png')] print:bg-white print:text-black">
